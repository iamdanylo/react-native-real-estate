...
import CommercialDetails from 'src/screens/SteppersScreens/CommercialDetails';
import CommercialSquare from 'src/screens/SteppersScreens/CommercialSquare';
...
type Props = {
  navigation: StackNavigationProp<RootStackParamsList, 'SellCommercialStepper'>;
  route: RouteProp<RootStackParamsList, 'SellCommercialStepper'>;
};

export default function SellCommercialStepper(props: Props) {
