...
import { currentPropertyId, currentPropertySize, currentPropertySquare } from 'src/redux/selectors/currentProperty';
import { saveProperty } from 'src/redux/actions/currentProperty';
import { AreaLocation, MeasureSquare, UIArea } from 'src/types';
import { convertSquareDetailsToUI, convertUISquareDetails, createRow, validateRows } from 'src/utils/squareScreens';
...
const IndustrialSquare = (props: Props) => {
...
export default IndustrialSquare;
